...
<div class="container">
    ...
    <div class="row">
        <div class="col">
             <h1 class="mt-4">Animais Para Doação</h1>
        ...
        <div class="card mb-3" style="">
            <div class="row g-0">
              <div class="col-md-2 col-sm-12 text-center">
                ...
                @else
                <img src="https://t3.ftcdn.net/jpg/05/16/27/58/360_F_516275801_f3Fsp17x6HQK0xQgDQEELoTuERO4SsWV.jpg"   class="img-fluidv img-list" alt="">
              ...
              <div class="col-md-10 col-sm-12">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    ...
                    @if(isset($item->phone))
                    <br>
                    <i class="bi bi-whatsapp"></i> Contato: <a href="#"> {{$item->phone}}</a>
                    @endif
                </p>
